                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <form action="{{ route('marketing.proses_inputLK_Marketing') }}" method="POST"
                                            ...
                                            @else
                                                @foreach ($dataTugas as $tugas)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('/download-tugas-marketing/' . $tugas->id_lk) }}"
        ...
        <div class="modal fade" id="editModal{{ $tugas->id_lk }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('proses_edit_tugas_marketing', ['id_lk' => $tugas->id_lk]) }}"
...
<script>
    document.getElementById('docxLink').addEventListener('click', function() {
        window.location.href = '/download-docx-marketing';
    });

    document.getElementById('excelLink').addEventListener('click', function() {
        window.location.href = '/download-excel-marketing';
    });
</script>
