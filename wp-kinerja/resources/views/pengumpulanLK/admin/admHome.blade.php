                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <form action="{{ route('admin.proses_inputLK') }}" method="POST"
                                            ...
                                            @else
                                                @foreach ($dataTugas as $tugas)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('/download-tugas-checker/' . $tugas->id_lk) }}"
        ...
        <div class="modal fade" id="editModal{{ $tugas->id_lk }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('proses_edit_tugas', ['id_lk' => $tugas->id_lk]) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="form-group">
                                Download :
                                <a href="{{ url('/download-tugas-hasil-revisi/' . $tugas->id_lk) }}"
                                    style="color: {{ $tugas->acc_tugas == 1 ? 'green' : ($tugas->acc_tugas == null || $tugas->acc_tugas == 0 ? 'red' : 'rgb(240, 54, 54)') }}">
                                    {{ $tugas->revisi_tugas }}
                                </a>
                            </div><br />
                            <div class="form-group">
...
<script>
    document.getElementById('docxLink').addEventListener('click', function() {
        window.location.href = '/download-docx-checker';
    });

    document.getElementById('excelLink').addEventListener('click', function() {
        window.location.href = '/download-excel-checker';
    });
</script>
