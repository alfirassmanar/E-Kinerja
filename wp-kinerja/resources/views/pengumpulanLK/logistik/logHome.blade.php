                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <form action="{{ route('logistik.proses_inputLK_Logistik') }}" method="POST"
                                            ...
                                            @else
                                                @foreach ($dataTugas as $tugas)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ url('/download-tugas-logistik/' . $tugas->id_lk) }}"
        ...
        <div class="modal fade" id="editModal{{ $tugas->id_lk }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('proses_edit_tugas_logistik', ['id_lk' => $tugas->id_lk]) }}"
...
<script>
    document.getElementById('docxLink').addEventListener('click', function() {
        window.location.href = '/download-docx-logistik';
    });

    document.getElementById('excelLink').addEventListener('click', function() {
        window.location.href = '/download-excel-logistik';
    });
</script>
