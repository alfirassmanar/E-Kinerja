...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="card mt-4 mb-4" style="width: 95%; margin-left: 26px;">
                    <h5 class="card-header bg-primary text-white">DataTabel - Absensi Staff</h5>
                    <div class="table-responsive text-nowrap">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                @else
                                    @foreach ($absensi as $row_absensi)
                                        @if (Auth::user()->role == 'supervisor admin')
                                            <tr>
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $row_absensi->no_pekerja }}</strong>
                                                </td>
                                                <td>{{ $row_absensi->nama_pekerja }}</td>
                                                <td>
                                                    <img src="{{ asset('storage/absensi/' . $row_absensi->foto_absensi) }}"
                                                        alt="img" style="max-width: 100px;">
                                                </td>
                                                <td>{{ $row_absensi->tanggal_masuk }}</td>
                                                <td>{{ $row_absensi->jam_masuk }}</td>
                                                <td>{{ $row_absensi->jam_keluar }}</td>
                                                <td
                                                    style="{{ $row_absensi->waktu_kerja >= '08:00:00' ? 'color: green;' : 'color: red;' }}">
                                                    {{ $row_absensi->waktu_kerja }}
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#"
                                                                ...
                                                                data-bs-target="#editModal{{ $row_absensi->id_absensi }}">
                                                                <i class="bx bx-edit-alt me-1"></i> Edit
                                                            </a>
                                                            <a href="{{ route('deleteAbsensiStaff', ['id_absensi' => $row_absensi->id_absensi]) }}"
                                                                class="btn btn-transparent"
                                                                onclick="event.preventDefault(); document.getElementById('delete-form-{{ $row_absensi->id_absensi }}').submit();">
                                                                <i class="bx bx-trash me-1"></i> Delete
                                                            </a>
                                                            <form id="delete-form-{{ $row_absensi->id_absensi }}"
                                                                action="{{ route('deleteAbsensiStaff', ['id_absensi' => $row_absensi->id_absensi]) }}"
    ...
    @foreach ($absensi as $tugas)
        <div class="modal fade" id="editModal{{ $tugas->id_absensi }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form
                        action="{{ route('proses_edit_admUpdateAbsensiStaff', ['id_absensi' => $tugas->id_absensi]) }}"
                        ...
                        <div class="modal-body">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="foto_absensi"
                                    value="{{ $tugas->foto_absensi }}" required style="width: 70%;">
                                <input type="file" class="form-control" name="foto_absensi" style="width: 70%;">
                            </div><br> --}}

                            <div class="form-group">
                                <label for="" class="small-text"><strong>Tanggal Masuk </strong></label>
                                <input type="date" class="form-control" name="tanggal_masuk"
                                    value="{{ $tugas->tanggal_masuk }}" style="width: 70%;">
                            </div><br>

                            <div class="form-group">
                                <label for="" class="small-text"><strong>Waktu Masuk </strong></label>
                                <input type="text" class="form-control" name="jam_masuk"
                                    value="{{ $tugas->jam_masuk }}" required style="width: 70%;">
                            </div><br>

                            <div class="form-group">
                                <label for="" class="small-text"><strong>Waktu Keluar </strong></label>
                                <input type="text" class="form-control" name="jam_keluar"
                                    value="{{ $tugas->jam_keluar }}" required style="width: 70%;">
                            </div><br>

                            <div class="form-group">
                                <label for="" class="small-text"><strong>Waktu Kerja </strong></label>
                                <input type="text" class="form-control" name="waktu_kerja"
                                    value="{{ $tugas->waktu_kerja }}" required style="width: 70%;">
                            </div><br>
